...
\footnotesize{Multi-value rules generate and assign a set of values to a variable.
...
\footnotesize{Multi-value rules can generate and assign a set of keys and values to a variable.
